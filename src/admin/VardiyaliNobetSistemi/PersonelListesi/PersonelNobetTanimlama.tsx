...
import { Plus, Pencil, Trash2, MoreVertical, Mail, Phone, Building2, ArrowRight, Clock, Calendar, User2, Users, FileText, X, Check, ArrowLeft } from 'lucide-react';
...
const PersonelNobetTanimlama: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {nobetTanimlamaPopup.isOpen && nobetTanimlamaPopup.personel && (
...
export default PersonelNobetTanimlama; 